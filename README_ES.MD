...
| Parámetro | Valor de ejemplo | Valores permitidos / Comportamiento real | Explicación completa |
| :--- | :--- | :--- | :--- |
| `UDP_HOST` | `"::"` | literal IP sin corchetes; si está vacío, se usa este valor | Dirección donde se vincula el servidor DNS.<br>El comodín IPv6 predeterminado (`::`) acepta tráfico IPv4 mapeado donde sea compatible, por lo que un solo socket recibe IPv6 e IPv4; de lo contrario, permanece solo en IPv6. Usa `0.0.0.0` para el comodín IPv4. Una dirección concreta limita el listener a esa familia. |
